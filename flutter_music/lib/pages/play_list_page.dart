  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        fixedColor: Color.fromARGB(255, 60, 60, 59),
        items: const [
...
class SongListView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Importa el AudioSource.
    return ListView.builder(
      itemCount: songs.length,
      itemBuilder: (context, index) {
        final song = songs[index];
      // Establece el color del texto según si el elemento es par o impar.
      final backgroundColor = index % 2 == 0 ? Colors.white : const Color.fromARGB(255, 244, 241, 241);
        return ListTile(
